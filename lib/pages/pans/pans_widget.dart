...
import '/pages/info_pans/info_pans_widget.dart';
...
import 'pans_model.dart';
export 'pans_model.dart';

class PansWidget extends StatefulWidget {
  const PansWidget({Key? key}) : super(key: key);

  @override
  _PansWidgetState createState() => _PansWidgetState();
}

class _PansWidgetState extends State<PansWidget> with TickerProviderStateMixin {
  late PansModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PansModel());
                                                                                                  ...
                                                                                                  Align(
                                                                                                    ...
                                                                                                    child: Container(
                                                                                                      ...
                                                                                                      child: Align(
                                                                                                        alignment: AlignmentDirectional(0.0, 0.0),
                                                                                                        child: AutoSizeText(
                                                                                                          'Сковородка из нержавеющей стали отличается своей устойчивостью и способностью выдержать стресс:  круглосуточный нагрев / механическое воздействие при перемешивании содержимого. \n\nПоэтому большинство посуды на профессиональной кухне сделанно из стали. ',
                                                                  ...
                                                                  child: Align(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            AutoSizeText(
                                                                          ' В продаже имеется большой выбор сковород из нержавеющей стали: с содержанием алюминия, с покрытием для защиты от пригорания. Предпочтение имеет конечно же сковорода из нержавеющей стали без каких либо покрытий и добавок.\nСуществует несколько категорий : 200, 300, 400.\n300 считается наиболее подходяще для готовки. ',
                                                                          textAlign:
                                                                              TextAlign.start,
