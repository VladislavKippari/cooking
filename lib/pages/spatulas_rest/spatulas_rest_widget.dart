...
import 'spatulas_rest_model.dart';
export 'spatulas_rest_model.dart';

class SpatulasRestWidget extends StatefulWidget {
  const SpatulasRestWidget({Key? key}) : super(key: key);

  @override
  _SpatulasRestWidgetState createState() => _SpatulasRestWidgetState();
}

class _SpatulasRestWidgetState extends State<SpatulasRestWidget>
    with TickerProviderStateMixin {
  late SpatulasRestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SpatulasRestModel());
                                                                                                  ...
                                                                                                  Align(
                                                                                                    ...
                                                                                                    child: Container(
                                                                                                      ...
                                                                                                      child: Align(
                                                                                                        alignment: AlignmentDirectional(0.0, 0.0),
                                                                                                        child: AutoSizeText(
                                                                                                          'Бамбук натуральный материал, который можно смело использовать при готовке еды. В тоже время нужно следить за бамбуком так как со временем влага может скапливаться в порах. ',
                                                                  ...
                                                                  child: Align(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            AutoSizeText(
                                                                          'Силикон гибкий и мягкий им невозможно повредить поверхность посуды. Минус в том, что силикон не является биологическим материалом, а изготовлен искуственно. Со временем от постоянного воздействия температуры силикон становится хрупким и небольшие кусочки могут попадать в еду. ',
                                                                          textAlign:
                                                                              TextAlign.start,
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child:
                                                                  ...
                                                                  path:
                                                                      'assets/videos/__(2000_x_1500_.)_(2000_x_1000_.)_(9).mp4',
                                                                  videoType:
                                                                      VideoType
                                                                          .asset,
                                                                  width: double
