...
import '/pages/infotyfsad/infotyfsad_widget.dart';
...
import 'teflonpan_model.dart';
export 'teflonpan_model.dart';

class TeflonpanWidget extends StatefulWidget {
  const TeflonpanWidget({Key? key}) : super(key: key);

  @override
  _TeflonpanWidgetState createState() => _TeflonpanWidgetState();
}

class _TeflonpanWidgetState extends State<TeflonpanWidget>
    with TickerProviderStateMixin {
  late TeflonpanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TeflonpanModel());
                                                                                                  ...
                                                                                                  Align(
                                                                                                    ...
                                                                                                    child: Container(
                                                                                                      ...
                                                                                                      child: Align(
                                                                                                        alignment: AlignmentDirectional(0.0, 0.0),
                                                                                                        child: AutoSizeText(
                                                                                                          'Так же есть чугунные и тефлоновые сковородки. \n\nЧугун слишком тяжелый и от этого не удобен для частого использования. \nПокрытие бывает антипригарным либо отсутствует.',
                                                                  ...
                                                                  child: Align(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            AutoSizeText(
                                                                          'Тефлон легкий, но это покрытие очень деликатное и быстро изнашевается. \nВ добавок согласно исследованиям, тефлоновое покрытие может выделять вредные вещества в небольшом количестве. ',
                                                                          textAlign:
                                                                              TextAlign.start,
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child:
                                                                  ...
                                                                  path:
                                                                      'assets/videos/__(2000_x_1500_.)_(2000_x_1000_.)_(6).mp4',
                                                                  videoType:
                                                                      VideoType
                                                                          .asset,
                                                                  width: double
